...
### ------------------------------------------------------
### - Date : 30-Jul-2011 15:01:36
### - Fichier d'origine : ../plugins/auto/breves/plugin.xml
...
# svn add lang/paquet-breves_fr.php
...
# svn mv base/breves_upgrade.php breves_administrations.php
